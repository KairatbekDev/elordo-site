...
export const metadata: Metadata = {
  ...
  description:
    'Строительная компания EL ORDO GROUP в Бишкеке. Продажа квартир премиум, бизнес и комфорт-класса напрямую от надежного застройщика. Беспроцентная рассрочка 0% до 36 месяцев без банка, программа Trade-in. ЖК Abu Dhabi, Madina Residence, Айкол+.',
  keywords: [
    'EL ORDO',
    'EL ORDO GROUP',
    'Эл Ордо',
  ...
  openGraph: {
    ...
    description:
      'Надежные жилые комплексы премиум, бизнес и комфорт-класса в Бишкеке. Беспроцентная рассрочка 0% до 36 месяцев без банка, программа Trade-in.',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'EL ORDO GROUP — Строительная компания в Бишкеке',
    description:
      'Квартиры премиум и бизнес-класса в Бишкеке. Беспроцентная рассрочка до 36 месяцев от застройщика.',
  },
};
