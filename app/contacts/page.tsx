    ...
    <main className="min-h-screen bg-[#fafbfa] text-gray-900 pb-20 selection:bg-[#d4b26f] selection:text-[#064734]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-100 flex flex-col justify-between hover:shadow-2xl transition-all">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-[#d4b26f]/20 text-[#8c6b23] flex items-center justify-center mb-5">
                <IconPhone className="w-6 h-6 text-[#064734]" />
              </div>
              <span className="text-[11px] font-black uppercase tracking-wider text-gray-400 block mb-1">
              ...
              <div className="space-y-1.5 text-base sm:text-lg font-black text-gray-900">
                {COMPANY_INFO.phones.map((phone, idx) => (
                  <a
                    ...
                    className="block hover:text-[#064734] transition-colors"
                  >
                    {phone}
                  </a>
                ))}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 inline-flex items-center gap-2 text-xs font-black text-emerald-700 hover:underline"
            >
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-100 flex flex-col justify-between hover:shadow-2xl transition-all">
            <div>
              ...
              <div className="mt-4 pt-3 border-t border-gray-100">
                <span className="text-[11px] text-gray-400 block mb-0.5">Официальный аккаунт:</span>
                <a
                  href={COMPANY_INFO.instagram}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-bold text-gray-900 hover:text-[#064734] transition-colors inline-flex items-center gap-1.5"
                >
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs font-semibold text-gray-700">
              <div className="p-3.5 rounded-2xl bg-[#fafbfa] border border-gray-100 flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-[#064734]/10 text-[#064734] flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                >
                  {PROJECTS_LIST.map((proj) => (
                    <option key={proj.slug} value={`${proj.name} (${proj.classType})`}>
                      {proj.name} ({proj.classType})
                    </option>
                  ))}
                  <option value="Консультация по всем объектам компании">
