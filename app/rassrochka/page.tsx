...
const CONTENT: Record<Locale, InstallmentContent> = {
  ru: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'Заключаем официальный Договор долевого участия за 30 минут. Без подтверждения доходов, поручителей и банков.',
      },
      {
        step: '04',
  ...
  kg: {
    ...
    descriptionText: 'Баштапкы төлөм батирдин жалпы наркынын 20%дан 30%га чейинки бөлүгүн түзөт. Калган сумма 36 айга чейин тең үлүштөр менен бөлүштүрүлөт. Төлөм графиги жекече макулдашылат: ай сайын, квартал сайын же бизнесиңиздин кирешесине жараша. Ашыкча төлөм 0%.',
    ...
    examples: [
      ...
      },
      {
        ...
        slug: 'madina-residence',
        badge: 'Хит сатуу',
        waText: 'Саламатсызбы! ЖК Madina Residence комплексиндеги 1 бөлмөлүү (43.59 м²) батирдин бөлүп төлөө эсеби боюнча ($1271/айына) планын жөнөтөсүзбү?',
      },
      {
        complex: 'ЖД Айкол +',
        type: '1 бөлмөлүү батир',
        ...
        slug: 'ajkol-plus',
        badge: 'Эко-предгорье',
        waText: 'Саламатсызбы! ЖД Айкол+ боюнча 1 бөлмөлүү батирдин бөлүп төлөө эсеби боюнча ($980/айына) бар-жогун тактап бересизби?',
      },
    ],
    ...
    steps: [
      ...
      },
      {
        ...
        desc: '30 мүнөттүн ичинде расмий ДДУ келишимин түзөбүз. Киреше тастыктоосуз жана банктарсыз.',
      },
      {
        step: '04',
  ...
  kz: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: '30 минут ішінде ресми ДДУ шартын жасаймыз. Кірісті растаусыз және банктерсіз.',
      },
      {
        step: '04',
  ...
  uk: {
    ...
    heroSubtitle: 'Комфортний вхід в угоду безпосередньо від забудовника EL ORDO GROUP. Індивідуальний графік платежів терміном до 36 місяців без відсотків, прихованих комісій та довідок про доходи.',
    ...
    descriptionText: 'Перший внесок становить від 20% до 30% від загальної вартості квартири. Залишок розподіляється рівними частинами на термін до 36 місяців. Графік виплат узгоджується індивідуально: щомісяця, щокварталу або з урахуванням сезонності вашого бізнесу. Переплата становить 0%.',
    ...
    examples: [
      ...
      },
      {
        ...
        slug: 'madina-residence',
        badge: 'Хіт продажів',
        waText: 'Доброго дня! Цікавить розрахунок розстрочки на 1-кімн. в ЖК Madina Residence ($1271/міс.). Надішліть планування.',
      },
      {
        complex: 'ЖД Айкол +',
        type: '1-кімнатна квартира',
        ...
        waText: 'Доброго дня! Цікавить розрахунок розстрочки на 1-кімн. в ЖД Айкол+ (Кок-Жар) з платежем $980/міс. Підкажіть наявність.',
      },
    ],
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'Укладаємо офіційний Договір пайової участі за 30 хвилин. Без поручителів і банків.',
      },
      {
        step: '04',
  ...
  en: {
    ...
    heroSubtitle: 'Direct entry into property ownership from developer EL ORDO GROUP. Custom payment schedule up to 36 months with zero interest, no hidden commissions, and no income verification.',
    ...
    descriptionText: 'Down payment ranges from 20% to 30% of total apartment cost. The remaining balance is split into equal payments for up to 36 months. Schedules are tailored individually: monthly, quarterly, or aligned with business cashflow. 0% extra fee.',
    ...
    examples: [
      ...
      },
      {
        ...
        totalPrice: '$65,385',
        downPayment: '$19,615 (30%)',
        downPaymentKgs: '≈ 1,716,000 KGS',
        monthly: '$1,271',
        monthlyKgs: '≈ 111,200 KGS',
        term: '36 months',
        slug: 'madina-residence',
        badge: 'Bestseller',
        waText: 'Hello! Interested in installment calculation for 1-room in Madina Residence ($1271/mo). Please share the layout.',
      },
      {
        ...
        totalPrice: '$50,400',
        downPayment: '$15,120 (30%)',
        downPaymentKgs: '≈ 1,323,000 KGS',
        monthly: '$980',
        monthlyKgs: '≈ 85,700 KGS',
        term: '36 months',
        slug: 'ajkol-plus',
        badge: 'Eco Foothills',
        waText: 'Hello! Inquiring about installment terms for 1-room apartment in Aykol+ ($980/mo). Please advise on availability.',
      },
    ],
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'Execute an official Equity Participation Agreement in 30 minutes without income statements or banks.',
      },
      {
        step: '04',
  ...
  zh: {
    ...
    heroSubtitle: '由 EL ORDO GROUP 开发商直签购房，门槛亲民。支持长达36个月免息个性化还款，零隐藏手续费，无需工作单位收入证明。',
    noticeText: '开发商自营免息分期付款让您彻底摆脱银行高额利息和繁琐信贷审核，在工程建设工期内按均摊节奏直接向开发商支付房款。',
    blockTitle: '免息分期细则与优势',
    descriptionText: '首付款比例仅需房屋总价的20%至30%，剩余款项在最长36个月内均摊付清。付款周期支持按月、按季度或根据企业经营周期量身定制，实际利率为0%。',
    ...
    examples: [
      ...
      },
      {
        ...
        totalPrice: '$65 385',
        downPayment: '$19 615 (30%)',
        downPaymentKgs: '≈ 1 716 000 索姆',
        monthly: '$1 271',
        monthlyKgs: '≈ 111 200 索姆',
        term: '36个月',
        slug: 'madina-residence',
        badge: '热销户型',
        waText: '您好！想了解玛迪娜公馆43.59平米一居室月供$1271分期方案，请发送户型图纸及付款测算。',
      },
      {
        ...
        totalPrice: '$50 400',
        downPayment: '$15 120 (30%)',
        downPaymentKgs: '≈ 1 323 000 索姆',
        monthly: '$980',
        monthlyKgs: '≈ 85 700 索姆',
        term: '36个月',
        slug: 'ajkol-plus',
        badge: '生态麓区',
        waText: '您好！咨询艾科尔+（Kok-Jar）月供$980的分期房源，请告知当前可售楼层及房号。',
      },
    ],
    ...
    steps: [
      ...
      },
      {
        step: '03',
        title: '凭有效证件签约',
        desc: '30分钟内高效签订正规国家备案购房合同，无需收入流水证明与银行介入。',
      },
      {
        step: '04',
        title: '官方登记与交付钥匙',
