...
const UI_STRINGS: Record<Locale, {
  ...
  ru: {
    ...
    installmentDesc: 'Беспроцентная внутренняя рассрочка до 36 месяцев напрямую от застройщика без банка.',
  ...
  kg: {
    ...
    installmentDesc: 'Банксыз түздөн-түз куруучудан 36 айга чейин пайызсыз ички бөлүп төлөө.',
  ...
  kz: {
    ...
    installmentDesc: 'Банксіз тікелей құрылыс салушыдан 36 айға дейін пайызсыз ішкі бөліп төлеу.',
  ...
  uk: {
    ...
    installmentDesc: 'Безвідсоткова внутрішня розстрочка до 36 місяців безпосередньо від забудовника без банку.',
  ...
  en: {
    ...
    installmentDesc: 'Interest-free developer installment plan up to 36 months with no bank involvement.',
