...
const COMPLEXES_DATA: Record<string, ComplexData> = {
  ...
  'madina-residence': {
    ...
    plans: [
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок А', area: '43.59 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок А', area: '45.21 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок В', area: '46.47 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок Б', area: '48.60 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок В', area: '49.03 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок В', area: '49.14 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок А', area: '49.90 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок Б', area: '50.01 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок А', area: '50.18 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок В', area: '53.15 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок А', area: '53.88 м²' },
      { rooms: 1, title: '1-ком квартира в ЖК Madina Residence блок Б', area: '57.87 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок А', area: '71.00 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок В', area: '71.07 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок Б', area: '74.30 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок А', area: '74.53 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок В', area: '74.59 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок В', area: '74.74 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок А', area: '75.90 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок А', area: '81.30 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок В', area: '81.31 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок А', area: '83.78 м²' },
      { rooms: 2, title: '2х ком квартира в ЖК Madina Residence блок В', area: '84.09 м²' },
      { rooms: 3, title: '3х ком квартира в ЖК Madina Residence блок Б', area: '108.48 м²' },
    ],
  },
  'ajkol-plus': {
    name: 'ЖД Айкол +',
